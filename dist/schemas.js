...
var NEVER = INVALID;
// src/schemas.ts
var AgentId = exports_external.string().uuid();
var RunId = exports_external.string().uuid();
var ModelParam = exports_external.object({
  id: exports_external.string(),
  value: exports_external.string()
});
var ModelSelection = exports_external.object({
  id: exports_external.string().min(1),
  params: exports_external.array(ModelParam).optional()
});
var RunStatus = exports_external.enum([
  "running",
  "finished",
  "error",
  "cancelled"
...
var StartRunInput = exports_external.object({
  agentId: AgentId,
  prompt: exports_external.string().min(1)
});
var StartRunOutput = exports_external.object({
  runId: RunId,
  agentId: AgentId
});
var PollRunInput = exports_external.object({
  runId: RunId
});
var PollRunOutput = exports_external.discriminatedUnion("status", [
  exports_external.object({
    runId: RunId,
    status: exports_external.literal("running"),
    messages: exports_external.array(exports_external.string())
  }),
  exports_external.object({
    runId: RunId,
    status: exports_external.literal("finished"),
    messages: exports_external.array(exports_external.string()),
    resultText: exports_external.string()
  }),
  exports_external.object({
    runId: RunId,
    status: exports_external.enum(["error", "cancelled"]),
    messages: exports_external.array(exports_external.string())
  })
]);
export {
